...
window.SCHEDULE_DATA = {
  ...
  people: [
    ...
    { pseudo: "pikachugraga",       hours: ["20","21","22"],           priority: ["22"], comment: "" },
    { pseudo: "honeythehivezsilk",  hours: ["20"],                     priority: ["20"], comment: "" },
    { pseudo: "Hubbie_21",          hours: ["22","23","00"],           priority: ["00"], comment: "" },
    { pseudo: "Billyboby23",        hours: ["20"],                     priority: ["20"], comment: "" },
    { pseudo: "Mabielle_fx",        hours: ["20","21"],                priority: ["21"], comment: "" },
    { pseudo: "uergap",             hours: ["20"],                     priority: ["20"], comment: "" },
    { pseudo: "Tdwhinybitch",       hours: ["20"],                     priority: ["20"], comment: "" },
    { pseudo: "trenchant0419",      hours: ["23","00"],                priority: ["00"], comment: "" },
    { pseudo: "Blong_NCS",          hours: ["20"],                     priority: ["20"], comment: "" },
    { pseudo: "im_kinoa22",         hours: ["21","22","23"],           priority: ["23"], comment: "" },
    { pseudo: "seniorpuel12345",    hours: ["20"],                     priority: ["20"], comment: "" }
  ],
